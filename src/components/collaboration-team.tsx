...
const Expert = ({ name, title, company, description, linkedIn, imagePath }: ExpertProps) => (
  ...
  >
    ...
    <div className="p-4 sm:p-6">
      <h3 className="text-xl sm:text-2xl text-neutral-200 mb-2">{name}</h3>
      <div className="text-white font-bold text-sm sm:text-base mb-2">{title} bei {company}</div>
      ...
      <a 
        ...
        className="inline-flex items-center gap-2 text-blue-500 bg-background border border-neutral-800 hover:border-neutral-700 px-3 sm:px-4 py-2 rounded-full transition-colors text-sm sm:text-base"
      >
...
export default function CollaborationTeam() {
  return (
    <div className="bg-[#0A0A0A] py-16 sm:py-24 md:py-32 lg:py-48 px-4">
      <div className="max-w-[85rem] mx-auto">
        <div className="rounded-xl overflow-hidden p-4 sm:p-8 md:p-12">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black italic text-center mb-4 sm:mb-6 text-neutral-200">
            Experten-Know-how aus der Kreativbranche
          </h2>
          <p className="text-lg sm:text-xl md:text-2xl text-neutral-400 text-center max-w-5xl mx-auto mb-8 sm:mb-12 leading-relaxed">
        ...
        >
          <Link href="/contact">
            <Button
              size="lg" 
              className="bg-primary font-bold text-base sm:text-lg px-8 sm:px-12 py-4 sm:py-6 h-auto"
            >
